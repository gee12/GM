...
public class Triangle3D implements Serializable {
    ...
    public Triangle3D(Point3DOdn p1, Point3DOdn p2, Point3DOdn p3) {
    ...
    public Triangle3D(Point3DOdn p1, Point3DOdn p2, Point3DOdn p3, Color col) {
	setTriangle(p1, p2, p3, col);
    }

    public Triangle3D(Triangle3D tria, Color col) {
    ...
    public static double getSide(Point3DOdn p1, Point3DOdn p2) {
    ...
    public boolean isPointInto(Point3DOdn point) {
	double s1 = new Triangle3D(v1, v2, point).getSpace();
	double s2 = new Triangle3D(v2, v3, point).getSpace();
	double s3 = new Triangle3D(v1, v3, point).getSpace();
	final double e = 1e-6;

	return ((s1 + s2 + s3) - space < e);
    }

    public static boolean isPointInto(Triangle3D tria, Point3DOdn point) {
	return new Triangle3D(tria).isPointInto(point);
    }
	...
	Triangle3D tria = (Triangle3D) obj;
    ...
    public String vertexToString(Point3DOdn p) {
	return String.format("(%d,%d,%d)", p.getX(), p.getY(), p.getZ());
    }

    //////////////////////////////////////////////////
    // get
    public Point3DOdn getV1() {
	return v1;
    }

    public Point3DOdn getV2() {
	return v2;
    }

    public Point3DOdn getV3() {
	return v3;
    }

    public Point3DOdn[] getVertexes() {
	return new Point3DOdn[]{v1, v2, v3};
    }
    ...
    public static double[] getSides(Triangle3D tria) {
	return new Triangle3D(tria).getSides();
    }
    ...
    public static double getSpace(Triangle3D tria) {
	return new Triangle3D(tria).getSpace();
    }
